...
func TestEventNamePredicate(t *testing.T) {
	...
	// Back To The Future (exact match)
	desiredEventName = "Back To The Future"
	actualEventName = "Back To The Future: The Musical"
