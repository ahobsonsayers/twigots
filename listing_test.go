...
func getTestTickets(t *testing.T) twigots.TicketListings {
...
func TestUnmarshalFeedJson(t *testing.T) {
	...
	require.Equal(t, 3, tickets[0].NumTickets)
	require.Equal(t, "£180.00", tickets[0].TotalPriceExclFee.String())
	...
	require.Equal(t, 2, tickets[1].NumTickets)
	require.Equal(t, "£130.00", tickets[1].TotalPriceExclFee.String())
	...
	require.Equal(t, 4, tickets[2].NumTickets)
	require.Equal(t, "£380.00", tickets[2].TotalPriceExclFee.String())
	...
	require.Equal(t, 1, tickets[3].NumTickets)
	require.Equal(t, "£280.00", tickets[3].TotalPriceExclFee.String())
